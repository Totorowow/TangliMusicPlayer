...
public class AnimatedVectorDrawableWrapper extends Animator {
    ...
    private AnimatorListenerWrapper createWrapper(Animator animator, AnimatorListener listener) {
    ...
    private static class AnimatorListenerWrapperM extends Animatable2.AnimationCallback implements AnimatorListenerWrapper {
        ...
        public AnimatorListenerWrapperM(Animator animator, AnimatorListener listener) {
            mAnimator = animator;
            mListener = listener;
        }
